...
import { getMockData, deleteMockData } from '@/components/admin/mock/MOCK_EventWin';
  ...
  const columns = [
    {
      ...
      dataIndex: 'title',
      render: (text, record) => (
        <ColumnLink onClick={() => navigate(`/mng/evnt/winner/${record.id}`)}>
          {text}
        </ColumnLink>
      )
    },
  ...
  return (
    <div style={{ position: 'relative' }}>
      <DataTable 
        ...
        rightButtons={
          <CommonButton onClick={() => navigate('/mng/evnt/winner/new')}>등록</CommonButton>
        }
      />
    </div>
  );
