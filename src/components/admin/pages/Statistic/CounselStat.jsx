...
import { getMockData } from '@/components/admin/mock/MOCK_onCnsStt';
import { counselStatSearch } from '@/components/admin/utils/search/counselStatSearch';
...
const CounselStat = () => {
  ...
  const {
    ...
    searchFunction: counselStatSearch,
    deleteMockData: (id) => {
