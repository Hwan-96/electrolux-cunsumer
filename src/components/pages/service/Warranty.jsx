  ...
  return (
    <ServiceLayout currentPage="제품의 보증기간" activeTab="warranty" title="제품의 보증기간">
      <div className="warranty-wrap">
        <p className="subj-txt1 txt1">일렉트로룩스 코리아에서는 품목별 소비자분쟁해결기준(공정거래위원회 고시)에 따라 아래와 같이 제품에 대한 보증을 실시 합니다.</p>
        <h3 className="subj-tit1 tit1">제품의 보증기간</h3>
        ...
        <table className="type1 view1 num ta1">
          ...
          <tbody>
            <tr>
              ...
              <td className="w2">제품 보증기간이라 함은 제조사 또는 제품 판매자가 소비자에게 정상적인 상태에서 자연 발생한 품질, <br />성능, 기능 하자에 대하여 무료수리를 해주겠다고
                약속 기간을 말한다.</td>
            </tr>
            <tr>
              <th scope="row">2</th>
        ...
        <h3 className="subj-tit1 tit1">품목별 보증기간</h3>
        <table className="type1 view2 ta2">
          <caption></caption>

          <thead>
            <tr>
              <th scope="col" className="w1">구분</th>
              <th scope="col" className="w2">보증기간</th>
              <th scope="col" className="w3">관련제품</th>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="tac">1년</td>
              <td><span className="fc-blue01 b">전제품</span></td>
            </tr>
            <tr>
              <th scope="row" rowSpan="5">핵심부품</th>
              <td className="tac">2년</td>
              <td>에어컨, 선풍기, 온풍기, 로터리히터, 팬히터</td>
            </tr>
            <tr>
              <td className="tac">10년</td>
              <td className="fc-blue01 b">
                세탁 MOTOR<br />
        ...
        <div className="subj-txt1 txt2">
          <span className="fc-blue01 b">※ 예외사항</span><br />
          * 영업용의 경우 보증기간 6개월 적용
        </div>

        <div className="hscr_box">
          <div className="scr_area">
            <table className="type1 view2 ta3 tac">
              <caption></caption>

              <thead>
                <tr>
                  <th scope="col" colSpan="2" className="w1">변경 항목</th>
                  <th scope="col" className="w2">내 용</th>
                  <th scope="col" className="w3">개정 전</th>
                  <th scope="col" className="w4">개정 후</th>
                  <th scope="col" className="w5">적용 제조월</th>
                </tr>
              </thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>3년</td>
                  <td className="b">10년</td>
                  <td>'09.11월<br />제조원 ~</td>
                </tr>
                <tr>
                  <th scope="row" colSpan="2">계절성 제품</th>
                  <td className="tal fc-blue01 b">
                    <ul className="bl-bar">
                      <li>가습기</li>
                    </ul>
                  </td>
                  <td>2년</td>
                  <td className="b">1년</td>
                  <td>'09.2월<br />제조원 ~</td>
                </tr>
                <tr>
                ...
                <tr>
                  <th scope="row" className="bdl-gr">단축 3개<br />품목</th>
                  <td className="tal">
                    <ul className="bl-bar">
        ...
        <h3 className="subj-tit1 tit1">부품별 보증기간</h3>
        <p className="subj-txt1 txt2">부품보증이라 함은 제품을 구성하는 각 부품에 대한 품질 보증을 말하며 그 기간은 다음과 같다.</p>
        <table className="type1 view1 num ta1">
          <caption></caption>
          <tbody>
            <tr>
              <th scope="row" className="w1">1</th>
              <td className="w2">당사에서 지정한 서비스 엔지니어 또는 당사의 수리자격을 취득한 자가 수리한 제품이 3개월 이내<br />동일 부위에 하자가 발생한 경우 무상으로 처리한다.
              </td>
            </tr>
            <tr>
              <th scope="row">2</th>
        ...
        <h3 className="subj-tit1 tit1">세부항목별 내구년수</h3>
        <table className="type1 view2 tac ta4">
          <caption></caption>

          <thead>
            <tr>
              <th scope="col" rowSpan="2" className="w1">품목</th>
              <th scope="col" colSpan="2" className="w1-2 bdl-gr">내용년수</th>
            </tr>
            <tr>
              <th scope="col" className="w2 bdl-gr">종전</th>
              <th scope="col" className="w3  bdl-gr">개정</th>
            </tr>
          </thead>

          <tbody>
            <tr>
              <td className="tal bln">
                <ul className="bl-bar">
                  <li>TV, 냉장고, 에어컨, 전축, 전자렌지, 제습기, 보일러</li>
                </ul>
              </td>
              <td className="b">7년</td>
              <td className="b" rowSpan="2">7년</td>
            </tr>
            <tr>
              <td className="tal bln">
                <ul className="bl-bar">
            ...
            <tr>
              ...
              <td className="b">6년</td>
              <td className="b" rowSpan="3">6년</td>
            </tr>
            <tr>
              <td className="tal bln">
                <ul className="bl-bar">
            ...
            <tr>
              ...
              <td className="b">4년</td>
              <td className="b" rowSpan="2">4년</td>
            </tr>
            <tr>
              <td className="tal bln">
                <ul className="bl-bar">
        ...
        <p className="subj-txt1">※ 제품별 부품보유기간은 제품의 잔존가 산출시 사용되며, "개정" 내용은 '2009년 1월 16일' 부터 적용됩니다.</p>
      </div>
    </ServiceLayout>
  );
};
